// ======================================================================
// \title  imuStatesTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <imuStates/Top/imuStatesTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <imuStates/Top/imuStatesPacketsAc.hpp>
...
// Public functions for use in main program are namespaced with deployment name imuStates
namespace imuStates {
