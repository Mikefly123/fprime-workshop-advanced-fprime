// ======================================================================
// \title  imuStatesTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef IMUSTATES_IMUSTATESTOPOLOGY_HPP
#define IMUSTATES_IMUSTATESTOPOLOGY_HPP
// Included for access to imuStates::TopologyState and imuStates::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <imuStates/Top/imuStatesTopologyDefs.hpp>

// Remove unnecessary imuStates:: qualifications
using namespace imuStates;
namespace imuStates {
/**
 ...
 * imuStates::TopologyState see: imuStatesTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type imuStates::TopologyState see: imuStatesTopologyDefs.hpp.
 *
