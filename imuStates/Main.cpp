...
#include <imuStates/Top/imuStatesTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    imuStates::TopologyState inputs;
    inputs.hostname = hostname;
    inputs.port = port_number;
    inputs.mpu.device = "/dev/i2c1";
    ...
    imuStates::setupTopology(inputs);
    imuStates::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    imuStates::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
