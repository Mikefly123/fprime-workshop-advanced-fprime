# imuStates Application

This deployment was auto-generated by the F' utility tool.

## Building and Running the imuStates Application

In order to build the imuStates application, or any other F´ application, we first need to generate a build directory. This can be done with the following commands:
...
The next step is to build the imuStates application's code.
```
fprime-util build
```
...
To run the ground system without starting the imuStates app:
```
...
```
cd imuStates/build-artifacts/<platform>/bin/
./imuStates -a 127.0.0.1 -p 50000
```
